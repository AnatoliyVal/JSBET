        ...
        <main>
                <div className="page-section active" id="page-igri">
                    ...
                    <div className="container">
                        <div className="category-row" aria-label="Фільтр за тематикою">
                            <ul className="category-row-list" role="list">
                                <li>
                                    <button 
                                        className={`category-chip ${selectedCategory === "Всі" ? "active" : ""}`} 
                                        type="button"
                    ...
                    <section className="section" aria-labelledby="fishing-heading">
                        ...
                        <section className="section" aria-labelledby="filtered-heading">
                            <div className="container">
                                <div className="section-header">
                                    <h2 id="filtered-heading" className="section-title">
                                        Ігри у категорії: {selectedCategory}
                                        <span className="section-count">
                                            · {GAMES_DB.filter(g => g.CategoryName === selectedCategory).length} ігор
                                        </span>
                                    </h2>
                                </div>
                                <div className="games-grid" role="list">
                                ...
                                {GAMES_DB.filter(g => g.CategoryName === selectedCategory).length === 0 && (
                                    <p style={{ color: "#a0a0a0", paddingTop: "20px" }}>
                                        На жаль, у цій категорії поки немає ігор.
                                    </p>
                                )}
                            </div>
                        </section>
