                ...
                <section style={S.section} aria-labelledby="history-heading">
                    <div className="container">
                        <div style={S.content}>
                            ...
                            <div style={S.block}>
                                <h2 style={S.heading}><i className="fa-solid fa-lightbulb" style={S.icon} /> Народження ідеї (Початок ери)</h2>
                                <p style={S.text}>
                            ...
                            <div style={S.block}>
                                <h2 style={S.heading}><i className="fa-solid fa-city" style={S.icon} /> Будівництво цифрового Стрипу</h2>
                                <p style={S.text}>
                            ...
                            <div style={S.block}>
                                <h2 style={S.heading}><i className="fa-solid fa-trophy" style={S.icon} /> JSBET сьогодні</h2>
                                <p style={S.text}>
