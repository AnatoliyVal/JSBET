...
const CATEGORY_INFO: Record<string, { description: string; rules: string }> = {
    "Фрукти": {
        description: "Яскравий слот з класичними фруктовими символами.",
        rules: "Збери 3+ однакових символів на лінії. Scatter запускає фріспіни з множниками."
    },
    "Рибалка": {
        description: "Морський слот про рибалку та великі улови.",
        rules: "Рибальський символ — Wild. Гачок запускає бонусний раунд 'Big Catch'."
    },
    "Тварини": {
        description: "Слот у світі дикої природи.",
        rules: "Wild розширюється на весь барабан. 10+ Scatter — 15 фріспінів."
    },
    "Єгипет": {
        description: "Таємниці стародавнього Єгипту та фараонів.",
        rules: "Книга — Wild і Scatter. 3+ книги дають 10 фріспінів з розширюваним символом."
    },
    "Боги": {
        description: "Слот між богами Олімпу.",
        rules: "Cascading перемоги підвищують множник. Блискавка Zeus — Wild."
    },
    "Класика": {
        description: "Ретро-слот в стилі класичних автоматів.",
        rules: "3 барабани, 5 ліній. 7 — найцінніший символ."
    },
    "Монети": {
        description: "Слот про золото та скарби.",
        rules: "Збери 6+ монет у Hold & Win. 3 Full — Grand Jackpot!"
    },
    "Магія": {
        description: "Казковий слот з принцесами.",
        rules: "Princess Wild розширюється. Starfall Feature після кожних 50 спінів."
    },
    "Містика": {
        description: "Слот з картами Таро.",
        rules: "Megaways: до 117 649 способів виграти. Cascades при кожній перемозі."
    },
    "Ацтеки": {
        description: "Скарби стародавніх ацтеків.",
        rules: "Маска Wild з ×2. 3+ піраміди — бонусний вибір скарбів."
    },
    "Джекпот": {
        description: "Прогресивні та фіксовані джекпоти.",
        rules: "6 горщиків золота — Grand. 3 повні рядки монет — Mega Jackpot."
    },
    "Хіп-хоп": {
        description: "Слот у стилі хіп-хоп культури.",
        rules: "DJ Wild замінює все. 5 SNOOP — ×1000 від ставки."
    },
    "Антик": {description: "Стародавня Греція та Рим.", rules: "Богиня Wild на барабанах 2–4. 3+ сонця — Free Games."},
    "Воїни": {
        description: "Епічний слот про бойових воїнів.",
        rules: "Меч — Wild. Щит — Scatter: 3+ дають 12 фріспінів."
    },
    "Природа": {
        description: "Тихоокеанський острів та корали.",
        rules: "Черепаха — Wild. 3+ квіток активують Reef Bonus."
    },
    "Конюшина": {
        description: "Ірландська удача та конюшина.",
        rules: "Лепрекон Wild з множником. 6+ конюшин — Hold & Win."
    },
    ...
    "Mythologie": {
        description: "Слот між легендарними богами.",
        rules: "Divine Wild з ×2. Clash Feature — бонусний поєдинок богів."
    },
};
const DEFAULT_INFO = {
...
const GameModal = ({game, onClose}: Props) => {
    ...
    return (
        <div style={S.overlay} ref={overlayRef} onClick={(e) => {
                    ...
                    <div style={S.infoSection}>
                        ...
                        <div style={S.infoBlock}>
                            ...
                            <div style={S.ratingRow}>
                                ...
                                {avg && avg.count > 0
                                    ? <span style={S.avgLabel}>{avg.avg.toFixed(1)} <span
                                        style={S.avgCount}>({avg.count})</span></span>
                                    : <span
                                        style={{fontSize: 12, color: "var(--color-text-muted)"}}>Ще немає оцінок</span>
                                }
                            </div>
                            {!user && (
                                <button style={S.loginHint} className="gm-login-hint"
